...
import levy.daniel.application.vues.desktop.metier.personne.CreationPersonneVueFxml;


/**
 * CLASSE PersonneVueController :<br/>
 ...
 *
 */
public class PersonneVueController implements IPersonneVueController {
	...
	/**
	 * personnesTableView : TableView&lt;IPersonneController&gt; :<br/>
	 * TableView&lt;IPersonneController&gt; affichant 
	 * la liste des Personne.<br/>
	 */
	@FXML
	private TableView<IPersonneController> personnesTableView;
	 ...
	 */
	@FXML
	private TableColumn<PersonneController, String> prenomTableColumn;
	
	/**
	 * modelSelection : TableViewSelectionModel&lt;IPersonneController&gt; :<br/>
	 * MODEL pour la sélection dans le TableView this.personnesTableView.<br/>
	 */
	private TableViewSelectionModel<IPersonneController> modelSelection;
	 ...
	 */
	@FXML
	private TableColumn<PersonneController, String> nomTableColumn;
	 ...
	 * Label "renseignements sur la Personne".<br/>
	 */
	@FXML
	 ...
	 * GridPane portant les renseignements sur une Personne.<br/>
	 */
	@FXML
	 ...
	 * Barre de boutons d'édition des Personne.<br/>
	 */
	@FXML
	 ...
	 * Bouton pour la création des Personne.<br/>
	 */
	@FXML
	 ...
	 * Bouton pour la modification des Personne.<br/>
	 */
	@FXML
	 ...
	 * Bouton pour la destruction des Personne.<br/>
	 */
	@FXML
	...
	private static final Log LOG 
		= LogFactory.getLog(PersonneVueController.class);

	// *************************METHODES************************************/
	
	/**
	 * method CONSTRUCTEUR PersonneVueController() :<br/>
	 * CONSTRUCTEUR D'ARITE NULLE.<br/>
	 * Automatiquement appelé en premier 
	 * lors du chargement du FXMLLoader.<br/>
	 * <br/>
	 */
	public PersonneVueController() {		
		super();		
	 ...
	 * associant avec des attributs du PersonneController.</li>
	...
	private void initialiserDonneesTbViewPersonnes() {
		 ...
		 * associant avec des attributs du PersonneController. */
		this.prenomTableColumn
			.setCellValueFactory(
					new PropertyValueFactory<PersonneController, String>("prenom"));
		
		this.nomTableColumn
			.setCellValueFactory(
					new PropertyValueFactory<PersonneController, String>("nom"));
	...
	private void creerListenerSurTableView() {
		...
		this.modelSelection.selectedItemProperty().addListener(
				new ChangeListener<IPersonneController>() {

					/**
					 * {@inheritDoc}
					 */
					@Override
					public void changed(final ObservableValue<? extends IPersonneController> pObservable,
							final IPersonneController pOldValue, final IPersonneController pNewValue) {

						PersonneVueController.this.afficherRenseignementsPersonne(pNewValue);
	...
	public final void creerPersonne() {
		...
		final CreationPersonneVueFxml vue 
			= new CreationPersonneVueFxml(this.accueilController);
        ...
        dialogStage.setTitle("Création de Personne");
	...
	public final void deletePersonneSelectionnee() {
		...
		if (selectedIndex >= 0) {
	        ...
	        alert.setTitle("Pas de Personne sélectionnée");
	        alert.setHeaderText("Pas de Personne sélectionnée");
	 ...
	 */
	@Override
	public final TableView<IPersonneController> getPersonnesTableView() {
	...
	public final void setPersonnesTableView(
			final TableView<IPersonneController> pPersonnesTableView) {
	 ...
	 */
	@Override
	public final TableViewSelectionModel<IPersonneController> getModelSelection() {
	...
	public final void setModelSelection(
			final TableViewSelectionModel<IPersonneController> pModelSelection) {
	 ...
	 */
	@Override
	public final TableColumn<PersonneController, String> getPrenomTableColumn() {
	...
	public final void setPrenomTableColumn(
			final TableColumn<PersonneController, String> pPrenomTableColumn) {
	 ...
	 */
	@Override
	public final TableColumn<PersonneController, String> getNomTableColumn() {
	...
	public final void setNomTableColumn(
			final TableColumn<PersonneController, String> pNomTableColumn) {
...
} // FIN DE LA CLASSE PersonneVueController.---------------------------------
