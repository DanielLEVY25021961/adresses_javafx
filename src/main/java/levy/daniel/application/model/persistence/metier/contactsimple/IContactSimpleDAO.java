...
/**
 * INTERFACE IContactSimpleDAO :<br/>
 * .<br/>
 * <br/>
 *
...
public interface IContactSimpleDAO {
	 ...
	 * @throws Exception
	 */
	IContactSimple create(IContactSimple pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	void persist(IContactSimple pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	Long createReturnId(IContactSimple pObject) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pList : Iterable&lt;IContactSimple&gt; : 
	 ...
	 * @throws Exception
	 */
	IContactSimple retrieve(IContactSimple pObject) throws Exception;
	 ...
	 * 
	 * @return : IContactSimple : objet métier recherché.<br/>
	 * 
	 * @throws Exception
	 */
	 ...
	 * @throws Exception
	 */
	Long retrieveId(IContactSimple pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	List<IContactSimple> findAll() throws Exception;
	 ...
	 * @throws Exception
	 */
	List<IContactSimple> findAllMax(
	 ...
	 * @throws Exception 
	 */
	IContactSimple update(IContactSimple pObject) throws Exception;
	 ...
	 * @param pObjectModifie : IContactSimple : 
	 * Objet métier contenant les modifications 
	 * à apporter à l'objet persistant dans le stockage.<br/>
	 * 
	 * @return IContactSimple : objet métier persistant modifié.<br/>
	 * 
	 * @throws Exception
	 */
	 ...
	 * <br/>
	 *
	 * @param pObject : IContactSimple : objet métier à détruire.<br/>
	 * 
	 * @return : boolean : 
	 ...
	 * @throws Exception
	 */
	boolean delete(IContactSimple pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	void deleteIterable(Iterable<IContactSimple> pList) throws Exception;
	 ...
	 * @throws Exception
	 */
	boolean deleteIterableBoolean(Iterable<IContactSimple> pList) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pObject : IContactSimple : objet métier à rechercher.<br/>
	 * 
	 * @return boolean : 
	 ...
	 * @throws Exception
	 */
	boolean exists(IContactSimple pObject) throws Exception;
	 ...
	 * @return : String.<br/>
	 */
	String afficherListeObjetsMetier(List<IContactSimple> pList);
	
	
	
} // FIN DE L'INTERFACE IContactSimpleDAO.-----------------------------------------
