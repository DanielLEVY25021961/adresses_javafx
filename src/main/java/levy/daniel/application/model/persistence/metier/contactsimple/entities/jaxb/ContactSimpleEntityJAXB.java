...
public class ContactSimpleEntityJAXB implements IContactSimple {
	 ...
	 */
	private static final Log LOG = LogFactory.getLog(ContactSimpleEntityJAXB.class);
	...
	// *************************METHODES************************************/
	 ...
	 /**
	 * method CONSTRUCTEUR ContactSimpleEntityJAXB() :<br/>
	...
	public final boolean equals(
		...
		if (!(pObjet instanceof ContactSimpleEntityJAXB)) {
			return false;
		}
		
		final ContactSimpleEntityJAXB other = (ContactSimpleEntityJAXB) pObjet;
