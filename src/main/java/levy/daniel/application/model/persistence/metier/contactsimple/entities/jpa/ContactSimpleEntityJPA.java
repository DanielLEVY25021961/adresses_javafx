package levy.daniel.application.model.persistence.metier.contactsimple.entities.jpa;
...
/**
 * CLASSE ContactSimpleEntityJPA :<br/>
 * Modelisation metier d'une ContactSimpleEntityJPA.<br/>
 * <br/>
 *
 ...
 *
 */
@Entity(name="ContactSimpleEntityJPA")
...
public class ContactSimpleEntityJPA implements IContactSimple {
	 ...
	 */
	private static final Log LOG = LogFactory.getLog(ContactSimpleEntityJPA.class);
	...
	// *************************METHODES************************************/
	 ...
	 /**
	 * method CONSTRUCTEUR ContactSimpleEntityJPA() :<br/>
	 * CONSTRUCTEUR D'ARITE NULLE.<br/>
	 * <br/>
	 */
	public ContactSimpleEntityJPA() {
		this(null, null, null, null, null, null, null);
	} // Fin de ContactSimpleEntityJPA().________________________________________________
	...
	public final boolean equals(
		...
		if (!(pObjet instanceof ContactSimpleEntityJPA)) {
			return false;
		}
		
		final ContactSimpleEntityJPA other = (ContactSimpleEntityJPA) pObjet;
	...
	public final String toString() {
		...
		builder.append("ContactSimpleEntityJPA [");
		if (this.id != null) {
			builder.append("id=");
...
} // FIN DE LA CLASSE ContactSimpleEntityJPA.----------------------------------------------
