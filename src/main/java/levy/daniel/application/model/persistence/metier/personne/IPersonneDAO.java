...
public interface IPersonneDAO {
	 ...
	 * @throws Exception
	 */
	IPersonne create(IPersonne pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	void persist(IPersonne pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	Long createReturnId(IPersonne pObject) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pList : Iterable&lt;IPersonne&gt; : 
	 * itérable d'objets métier à persister dans le stockage.<br/>
	 * 
	 * @return Iterable&lt;IPersonne&gt; : 
	 * itérable d'objets métier persistés dans le stockage.<br/>
	 * 
	 * @throws Exception
	 */
	Iterable<IPersonne> save(Iterable<IPersonne> pList) throws Exception;
	 ...
	 * @throws Exception
	 */
	IPersonne retrieve(IPersonne pObject) throws Exception;
	 ...
	 * 
	 * @return : IPersonne : objet métier recherché.<br/>
	 * 
	 * @throws Exception
	 */
	IPersonne findById(Long pId) throws Exception;
	 ...
	 * @throws Exception
	 */
	Long retrieveId(IPersonne pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	List<IPersonne> findAll() throws Exception;
	 ...
	 * (List&lt;IPersonne&gt;) dont les IDs appartiennent 
	 * à la Collection itérable d'IDs passée en paramètre.</li>
	 * <li>Inclut dans la liste les sous-classe de IPersonne 
	 * (strategy=InheritanceType.JOINED) 
	 * avec la visibilité (Typé) IPersonne.</li>
	 * </ul>
	 ...
	 * 
	 * @return Iterable&lt;IPersonne&gt; : List&lt;IPersonne&gt;.<br/>
	 * 
	 * @throws Exception 
	 */
	Iterable<IPersonne> findAll(Iterable<Long> pIds) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pObject : IPersonne : objet métier avec ID 
	 ...
	 * @throws Exception 
	 */
	IPersonne update(IPersonne pObject) throws Exception;
	 ...
	 * @param pObjectModifie : IPersonne : 
	 * Objet métier contenant les modifications 
	 * à apporter à l'objet persistant dans le stockage.<br/>
	 * 
	 * @return IPersonne : objet métier persistant modifié.<br/>
	 * 
	 * @throws Exception
	 */
	IPersonne update(Long pId, IPersonne pObjectModifie) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pObject : IPersonne : objet métier à détruire.<br/>
	 * 
	 * @return : boolean : 
	 ...
	 * @throws Exception
	 */
	boolean delete(IPersonne pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	void deleteIterable(Iterable<IPersonne> pList) throws Exception;
	 ...
	 * @throws Exception
	 */
	boolean deleteIterableBoolean(Iterable<IPersonne> pList) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pObject : IPersonne : objet métier à rechercher.<br/>
	 * 
	 * @return boolean : 
	 ...
	 * @throws Exception
	 */
	boolean exists(IPersonne pObject) throws Exception;
	 ...
	 * @return : String.<br/>
	 */
	String afficherListeObjetsMetier(List<IPersonne> pList);
	
	
	
} // FIN DE L'INTERFACE IPersonneDAO.-----------------------------------------
