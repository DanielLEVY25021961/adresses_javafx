package levy.daniel.application.model.persistence.metier.personne.dao.jpaspring.impl;
...
import levy.daniel.application.model.persistence.metier.personne.IPersonneDAO;
 ...
 * </p>
 * <p>
 * <b>Personne</b> modélise un un <i>concept</i> 
 * de <b>Personne</b> avec ********
 ...
 * </p>
 * <ul>
 * <li>DAO <b>CONCRET</b> pour les <b>Personne</b>.</li>
 * <li>
 * Implémente l'interface <b>IPersonneDAO</b>.
 * </li>
 * <li>
 ...
 * alt="implémentation des DAOs Personne JPA SPRING" border="1" align="center" />
 * </li>
 * </ul>
 * 
 * <p>
 ...
 *
 */
@Repository("PersonneDAOJPASpring")
public class PersonneDAOJPASpring implements IPersonneDAO {
	
	// ************************ATTRIBUTS************************************/
	
	/**
	 * "Classe PersonneDAOJPASpring".<br/>
	 */
	public static final String CLASSE_PERSONNEDAO_JPA_SPRING 
		= "Classe PersonneDAOJPASpring";
	 ...
	 */
	private static final Log LOG = LogFactory.getLog(PersonneDAOJPASpring.class);
	...
	public IPersonne create(
			final IPersonne pObject) throws Exception {
		...
		try {
			...
			final PersonneEntityJPA entity 
				= new PersonneEntityJPA(pObject);
			...
			this.gestionnaireException
				.gererException(
						CLASSE_PERSONNEDAO_JPA_SPRING
							, "Méthode create(IPersonne pObject)", e);
	...
	public void persist(
		...
		try {
			...
			this.gestionnaireException
				.gererException(
						CLASSE_PERSONNEDAO_JPA_SPRING
							, "Méthode persist(IPersonne Object)", e);
	...
	public Long createReturnId(
		...
		final IPersonne objectPersistant 
			= this.create(pObject);
	 ...
	 */
	@Override
	public Iterable<IPersonne> save(
		...
		final Iterator<IPersonne> iteS = pList.iterator();
			...
			while (iteS.hasNext()) {
				...
				if (!this.exists(objet)) {
					...
					if (objet != null) {
						 ...
						 * de l'objet métier. */
						final PersonneEntityJPA entity 
							= new PersonneEntityJPA(objet);
						
						IPersonne objectPersistant = null;
	...
	public IPersonne findById(
		...
		try {
			...
			objetTrouve 
				= this.entityManager
					.find(PersonneEntityJPA.class, pId);
	...
	public Long retrieveId(
		...
		final IPersonne object = this.retrieve(pObject);
	 ...
	 */
	@Override
	public List<IPersonne> findAll() throws Exception {
	 ...
	 */
	@Override
	public List<IPersonne> findAllMax(
	 ...
	 */
	@Override
	public Iterable<IPersonne> findAll(
		...
		while (iteratorID.hasNext()) {
			...
			final IPersonne objetEnBase = this.findById(id);
	...
	@Override
	public IPersonne update(
			final Long pId, final IPersonne pObjectModifie) 
												throws Exception {
		...
		final IPersonne objectPersistant = this.findById(pId);
		...
		try {
			...
			/* Obtention d'une Entity JPA à partir de l'objet métier. */
			final PersonneEntityJPA entity 
				= new PersonneEntityJPA(pObjectModifie);
	...
	public boolean delete(
		...
		final IPersonne objectPersistant = this.retrieve(pObject);
		...
		try {
			...
			/* Obtention d'une Entity JPA à partir de l'objet métier. */
			final PersonneEntityJPA entity 
				= new PersonneEntityJPA(objectPersistant);
	...
	public void deleteIterable(
			final Iterable<IPersonne> pList) throws Exception {
		...
		final Iterator<IPersonne> itePersistants = pList.iterator();
		...
		while (itePersistants.hasNext()) {
			...
			final IPersonne objectPersistant = this.retrieve(objet);
	...
	public Long count() throws Exception {
		...
		/* Récupère la liste d'Objets métier de Type paramétré IPersonne. */
	...
	public void ecrireStockageDansConsole() throws Exception {
		...
		final List<IPersonne> contenuStockage = this.findAll();
		...
		for (final IPersonne objet : contenuStockage) {
	...
	public String afficherListeObjetsMetier(
		...
		for (final IPersonne objetMetier : pList) {
