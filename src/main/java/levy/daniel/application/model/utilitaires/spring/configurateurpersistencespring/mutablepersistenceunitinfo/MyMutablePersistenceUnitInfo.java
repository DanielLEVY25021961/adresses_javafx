...
/**
 * CLASSE MyMutablePersistenceUnitInfo :<br/>
 * .<br/>
 * <br/>
 *
 ...
 *
 */
public class MyMutablePersistenceUnitInfo 
	...
	/**
	 * IMyDataSource utilisé dans la présente classe.
	 * <ul>
	 * <li>déduite de transactionType 
	 * (jtaDataSource existe si transactionType = JTA).</li>
	 * </ul>
	 */
	private transient IMyDataSource dataSource;
	...
	private static final Log LOG 
		= LogFactory.getLog(MyMutablePersistenceUnitInfo.class);
	 ...
	 */
	public MyMutablePersistenceUnitInfo() {
	 ...
	 * @param pPersistenceProviderClassName
	 * @param pManagedClassNames
	 */
	public MyMutablePersistenceUnitInfo(
			final LecteurConfigurationBaseSpring pLecteurConfigurationBaseSpring
			, final String pPersistenceProviderClassName
			, final List<String> pManagedClassNames) {
		
		this(pLecteurConfigurationBaseSpring
				, pPersistenceProviderClassName
				, null
				, new MyDataSourceC3P0(pLecteurConfigurationBaseSpring).getDataSource()
				, null
				, null
				, null
				, pManagedClassNames
	 ...
	 * @param pLecteurConfigurationBaseSpring
	 * @param pPersistenceProviderClassName
	 * @param pJtaDataSource
	 * @param pNonJtaDataSource
	 * @param pMappingFileNames
	 * @param pJarFileUrls
	 * @param pPersistenceUnitRootUrl
	 * @param pManagedClassNames
	 * @param pManagedPackages
	 * @param pExcludeUnlistedClasses
	 * @param pSharedCacheMode
	 * @param pValidationMode
	 * @param pPersistenceXMLSchemaVersion
	 * @param pPersistenceProviderPackageName
	 * @param pClassLoader
	 * @param pNewTempClassLoader
	 */
	public MyMutablePersistenceUnitInfo(
			final LecteurConfigurationBaseSpring pLecteurConfigurationBaseSpring
			, final String pPersistenceProviderClassName
		...
		this(pLecteurConfigurationBaseSpring.getPersistenceUnitName()
				, pPersistenceProviderClassName
				, PersistenceUnitTransactionType.valueOf(pLecteurConfigurationBaseSpring.getTypeTransaction())
				, pJtaDataSource
				, pNonJtaDataSource
				, pMappingFileNames
				, pJarFileUrls
				, pPersistenceUnitRootUrl
				, pManagedClassNames
				, pManagedPackages
				, pExcludeUnlistedClasses
				, pSharedCacheMode
				, pValidationMode
				, pLecteurConfigurationBaseSpring.getPropertiesConfiguration()
...
//				this.persistenceProviderPackageName);
	...
	public String toString() {
		...
		builder.append("MyMutablePersistenceUnitInfo [");
	...
	public final String toStringAmeliore() {
		...
		stb.append("VALEURS dans LE CONTENEUR MyMutablePersistenceUnitInfo : ");
		...
		if (this.dataSource != null) {
			stb.append(this.dataSource.afficherDataSource());
		}
	...
	*/
	...
	/**
	 * Getter du IMyDataSource utilisé dans la présente classe.
	 * <ul>
	 * <li>déduite de transactionType 
	 * (jtaDataSource existe si transactionType = JTA).</li>
	 * </ul>
	 *
	 * @return this.dataSource : IMyDataSource.<br/>
	 */
	public final IMyDataSource getDataSource() {
...
} // FIN DE LA CLASSE MyMutablePersistenceUnitInfo.------------
