	...
	*/
	...
	public void testLireProperties() {
		...
		if (AFFICHAGE_GENERAL && affichage) {
			...
			System.out.println(
					"DRIVER DANS LE CONTENEUR LecteurPropertiesSpring : " 
					+ this.lecteurPropertiesSpring.getDriver());
			
			System.out.println(
					"LOGIN DANS LE CONTENEUR LecteurPropertiesSpring : " 
					+ this.lecteurPropertiesSpring.getUserName());

			System.out.println(
					"PASSWORD DANS LE CONTENEUR LecteurPropertiesSpring : " 
					+ this.lecteurPropertiesSpring.getPassword());
			
			System.out.println();
			System.out.println(
					"JTADATASOURCE DANS LE CONTENEUR LecteurPropertiesSpring : " 
			...
			System.out.println();
			System.out.println(
					"NON-JTADATASOURCE DANS LE CONTENEUR LecteurPropertiesSpring : " 
